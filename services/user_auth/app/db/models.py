...
class Conversation(Base):
    ...
    status = Column(Enum('Active','Inactive', name="STATUS", create_type=False))
    start_time = Column(TIMESTAMP)
    end_time = Column(TIMESTAMP)
    duration = Column(Integer)
    grammars= relationship("Grammar")
...
class Grammar(Base):
    ...
    level = Column(Enum('1','2','3','4','5','6', name="LEVEL", create_type=False))
